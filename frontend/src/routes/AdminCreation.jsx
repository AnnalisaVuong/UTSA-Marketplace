  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#0c2340] text-white">
        <h1 className="text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl dark:text-white mb-10">
          Create Account{" "}
        </h1>
        <form className="w-full max-w-md" onSubmit={submitData}>
          ...
          <div className="flex flex-row gap-4 mt-10">
            <input
              type="submit"
              value="Create"
              className="bg-white hover:bg-orange-300 text-[#ab6809] font-bold py-3 px-4 basis-2/4
                focus:outline-none focus:ring focus:ring-orange-200 rounded"
            />
            <input
              type="reset"
              value="Clear Form"
              className="bg-white hover:bg-orange-300 text-[#ab6809] font-bold py-3 px-4 rounded basis-2/4
                focus:outline-none focus:ring focus:ring-orange-200 rounded"
            />
          </div>
        </form>
