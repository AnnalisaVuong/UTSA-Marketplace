          ...
          <div className="flex w-96 p-6 shadow-lg bg-orange-500 rounded-md flex-col justify-center">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              <form className="space-y-6" action="#" method="POST">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <label htmlFor="confirmed-password" className="block text-sm font-medium leading-6 text-gray-50">
                      Confirm Password
                    </label>
                  </div>
                  <div className="mt-2">
                ...
                <div>
                  <label htmlFor="fName" className="block text-sm font-medium leading-6 text-gray-50">
                    First Name
                  </label>
                  <div className="mt-2">
                    <input
                ...
                <div>
                  <label htmlFor="lName" className="block text-sm font-medium leading-6 text-gray-50">
                    Last Name
                  </label>
                  <div className="mt-2">
                    <input
                ...
                <div>
                  <label htmlFor="phone-number" className="block text-sm font-medium leading-6 text-gray-50">
                    Phone Number
                  </label>
                  <div className="mt-2">
                    <input
