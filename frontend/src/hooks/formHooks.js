 ...
 *
 * @returns {[React.ChangeEventHandler<HTMLInputElement>, import("@lib/types").SubmissionCallback, {}]} - A function to set the form data to be attached as an event listener
 *
 * @example
